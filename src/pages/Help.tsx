...
const FAQ_DATA: FAQItem[] = [
  {
    ...
    answer:
      "Escrow (Güvenli Havuz), alıcı ve satıcıyı koruyan akıllı bir emanet protokolüdür. Alıcı sipariş verdiğinde ödeme Litecoin (LTC) olarak sistem havuzuna kilitlenir. Satıcı ürünü kargolayıp teslim edene kadar bu tutar kilitli kalır. Alıcı teslimatı onayladığında veya teslimat süresi sorunsuz dolduğunda tutar satıcının cüzdanına aktarılır.",
  },
  {
    id: "e2",
    category: "escrow",
  ...
  },
  {
    ...
    answer:
      "Hesap güvenliğiniz için üç temel protokolü deaktif bırakmamalısınız: 1) Güçlü bir şifre seçin ve PGP Anahtarı tanımlayın. 2) Güvenlik ayarlarından iki aşamalı doğrulamayı (2FA / TOTP) aktif edin. 3) Oltalama saldırılarına karşı her girişte 'Anti-Phishing Kodu' kontrolü gerçekleştirin.",
  },
  {
    id: "p1",
    category: "pgp",
    ...
    answer:
      "PGP (Pretty Good Privacy), satıcılar arası mesajlaşmalarda ve hassas teslimat bilgilerinin şifrelenmesinde kullanılır. PGP şifrelemesi sunucu tarafında çözülemez; yalnızca teslimat adresi gibi kritik bilgileri alıcının kendi özel anahtarıyla çözmesini sağlar. Böylece tam gizlilik korunur.",
  },
  {
    id: "pm1",
    category: "payments",
    ...
    answer:
      "Hızlı işlem onay süreleri, son derece düşük ağ ücretleri ve yüksek gizlilik sunması sebebiyle ana para birimi olarak sadece Litecoin (LTC) desteklenmektedir.",
  },
  {
    id: "g1",
    category: "general",
    ...
    answer:
      "Tam gizlilik protokolleri gereği, şifre sıfırlama veya 2FA devre dışı bırakma işlemleri yalnızca 2FA kurulumu sırasında size sunulan 'Acil Durum Kurtarma Kodları' (Backup Codes) ile yapılabilir. Kurtarma kodlarınızı kaybettiyseniz hesabınız kalıcı olarak kilitlenir.",
  },
];
        ...
        <div className="glass-card rounded-3xl p-6 border border-white/5 bg-gradient-to-r from-[#030303] to-[#010101] flex items-center gap-4 relative overflow-hidden shadow-2xl">
          ...
          <div>
            <h1 className="text-sm font-black text-white uppercase tracking-[0.2em]">
              YARDIM MASASI & DESTEK PROVAYDERİ
            </h1>
            <p className="text-[8px] text-zinc-500 font-bold uppercase tracking-widest mt-0.5">
              Sorularınıza hızlı çözümler alın veya yeni bir şifreli destek
              bileti açın
            </p>
          </div>
        </div>
                  ...
                  return (
                    <div
                      ...
                      className={`glass-card rounded-2xl border transition-all duration-300 overflow-hidden ${
                        isExpanded
                          ? "border-red-600/30 bg-[#020202]"
                          : "border-white/5 bg-[#030303]/40 hover:border-white/10"
                      }`}
                    >
                      <button
                        onClick={() =>
                ...
                {!ticketResult ? (
                  ...
                  >
                    <div className="space-y-1.5">
                      <label className="text-[7.5px] text-zinc-600 font-black uppercase tracking-widest">
                        KATEGORİ
                      </label>
                      <select
                    ...
                    >
                      {submittingTicket ? "GÖNDERİLİYOR..." : "TALEP GÖNDER"}{" "}
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-[7px] text-zinc-500 font-bold uppercase tracking-widest">
                        EN GEÇ 12 SAAT İÇİNDE YANITLANACAKTIR
                      </p>
                    </div>

                    <div className="bg-zinc-950 border border-white/5 rounded-xl p-3">
                      <span className="text-[6.5px] text-zinc-600 font-black uppercase tracking-widest block">
                        BİLET NUMARASI
                      </span>
                      <span className="text-white text-xs font-black tracking-widest select-all">
                        {ticketResult}
                      </span>
                    </div>
