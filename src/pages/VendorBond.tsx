      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="glass-card rounded-2xl p-4 border border-white/5 flex flex-wrap items-center justify-between gap-4 bg-gradient-to-r from-[#030303] to-[#010101] shadow-2xl relative overflow-hidden">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-[11px] font-black uppercase text-white tracking-widest">
                {t("bond.title")}
              </h1>
          ...
          <div className="flex items-center gap-2 bg-[#050505] px-3 py-1.5 border border-white/5 rounded-xl font-mono text-[9px] font-black text-red-600 tracking-wider">
            ...
            1 LTC = ${ltcPrice.toFixed(2)} USD{" "}
            {fetchingPrice ? "(YÜKLENİYOR)" : "(CANLI BESLEME)"}
          </div>
        </div>
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <p className="text-[10px] text-zinc-400 font-bold max-w-lg mx-auto leading-relaxed uppercase">
                DOLANDIRICILIK VE ZARARLI FAALİYETLERİ ENGELLEMEK AMACIYLA,
                PORTALDA ÜRÜN LİSTELEMEDEN ÖNCE DETAYLI BİR GÜVEN TEMİNATI
                YATIRMALISINIZ.
              </p>
            </div>
            ...
            <div className="glass-card rounded-2xl p-6 border border-white/5 bg-gradient-to-b from-[#020202] to-[#010101] shadow-2xl space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-[#030303] border border-white/5 rounded-2xl p-5 space-y-1">
                  <div className="text-[8px] text-zinc-500 font-mono uppercase tracking-wider">
                    {t("bond.deposited")}
                  </div>
              ...
              >
                <div className="space-y-2">
                  <p className="text-[10px] text-zinc-400 font-bold uppercase tracking-wider leading-relaxed">
                    YENİ SATICI ONAYI İÇİN YUKARIDA BELİRTİLEN{" "}
                    <span className="text-red-600">{requiredLtc} LTC</span>{" "}
                    TUTARI AŞAĞIDAKİ ADRESE TRANSFER EDİNİZ.
                  </p>
                </div>
                ...
                <div className="border-t border-white/5 pt-6 max-w-lg mx-auto space-y-4">
                  {!simulating ? (
                    ...
                    >
                      <Cpu className="w-4 h-4" /> ÖDEMEYİ KONTROL ET (SCAN
                      BLOCKCHAIN)
                    </button>
                  ) : (
                  ...
                  <div className="flex items-center justify-center gap-2 text-[9px] text-zinc-500 font-bold uppercase tracking-wider">
                    ...
                    AĞ DURUMU: AKTİF • 3 BLOK ONAYI GEREKLİ
                  </div>
                </div>
              </motion.div>
            )}
        ...
        <div className="glass-card rounded-2xl p-6 border border-white/5 bg-[#010101] shadow-2xl space-y-4">
          ...
          <ul className="space-y-2.5 text-[9px] text-zinc-400 font-bold uppercase tracking-wider leading-relaxed">
            <li className="flex items-start gap-2.5">
              ...
              <span>
                YATIRILAN GÜVEN TEMİNATI (BOND) SATICI HESABINDA TAMAMEN KİLİTLİ
                (LOCKED) DURUR.
              </span>
            </li>
            <li className="flex items-start gap-2.5">
              <span className="text-red-600 shrink-0 font-black">•</span>
              <span>
                ALICIYI DOLANDIRMA VEYA KURAL İHLALİ TESPİT EDİLİRSE, TEMİNAT
                TUTARI ALICININ ZARARINI KARŞILAMAK AMACIYLA EKSİLEBİLİR VEYA EL
                KONULABİLİR.
              </span>
            </li>
            <li className="flex items-start gap-2.5">
              <span className="text-red-600 shrink-0 font-black">•</span>
              <span>
                SİSTEMDE AKTİF LİSTELENEN ÜRÜNLERİNİZ VEYA DEVAM EDEN
                SİPARİŞLERİNİZ VARKEN DEPOZİTONUZUN İADESİNİ TALEP EDEMEZSİNİZ.
              </span>
            </li>
            <li className="flex items-start gap-2.5">
              <span className="text-red-600 shrink-0 font-black">•</span>
              <span>
                SİTE YÖNETİMİ DEPOZİTO FİYATINI DEĞİŞTİRME YETKİSİNE SAHİPTİR.
                YUKARIDA LİSTELENEN TUTAR ADMİN PANELİNDEN CANLI OLARAK
                GÜNCELLENİR.
              </span>
            </li>
          </ul>
