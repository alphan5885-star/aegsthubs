        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <div className="obsidian-card p-10 rounded-[40px] border-2 border-white/5 space-y-6 relative overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button className="bg-red-600 text-white px-8 py-4 rounded-[24px] text-[10px] font-black uppercase tracking-widest hover:scale-105 transition-all">
                  GÜNCELLE
                </button>
              </div>
              {savedCode && (
                ...
                <div className="bg-green-600/5 border border-green-600/10 rounded-[24px] p-6 flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-0.5">
                      ...
                      <div className="text-[8px] text-green-500/70 font-bold uppercase tracking-widest">
                        YÜKSEK_GÜVENLİK_KİMLİĞİ
                      </div>
                    </div>
                  </div>
                  <button
                    onClick={async () => {
                      if (
                        window.confirm(
                          "2FA korumasını devre dışı bırakmak istediğinizden emin misiniz?",
                        )
                      ) {
                        try {
          ...
          <div className="lg:col-span-4 space-y-10">
            ...
            <div className="obsidian-card p-8 rounded-[40px] border-2 border-white/5 space-y-4">
              <h4 className="text-[9px] text-zinc-800 font-black uppercase tracking-widest">
                ACİL_DURUM_TEMİZLİĞİ
              </h4>
