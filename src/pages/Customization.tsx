        ...
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-8 border-b border-white/5 pb-10">
          <div className="space-y-4">
            <div className="flex items-center gap-3 text-[9px] text-red-600 font-black tracking-[0.4em] uppercase">
              <Zap className="w-4 h-4 shadow-[0_0_10px_#ff0000]" />{" "}
              SYSTEM_CONFIG // CORE_v4.5
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="obsidian-card p-8 rounded-[40px] border-2 border-white/5 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <input
                ...
                onChange={(e) =>
                  updateSettings({ themeHue: parseInt(e.target.value) })
                }
          ...
          <div className="obsidian-card p-8 rounded-[40px] border-2 border-white/5 space-y-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              >
                SIDEBAR_COLLAPSE{" "}
                <span>{settings.sidebarCollapsed ? "ON" : "OFF"}</span>
              </button>
              <button
                onClick={() =>
                  updateSettings({
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="bg-white/5 border border-white/5 p-3 rounded-xl text-zinc-500 hover:text-white transition-all"
                >
                ...
                {backgroundUrl && (
                  <button
                    ...
                    className="bg-white/5 border border-white/5 p-3 rounded-xl text-zinc-500 hover:text-red-600 transition-all"
                  >
            ...
            {backgroundUrl && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <div className="relative h-24 rounded-2xl overflow-hidden border border-white/10">
                  ...
                  />
                  <div className="absolute inset-0 flex items-center justify-center text-[8px] font-black text-white/20 uppercase tracking-[0.5em]">
                    PREVIEW_ACTIVE
                  </div>
                </div>
                <div className="space-y-4">
